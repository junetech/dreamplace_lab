...
class ElectricOverflow(nn.Module):
    ...
    def forward(self, pos):
        ...
        density_cost = (
            (density_map - self.target_density * bin_area)
            .clamp_(min=0.0)
            .sum()
            .unsqueeze(0)
        )
...
def plot(plot_count, density_map, padding, name):
    ...
    density_map = density_map[
        padding : density_map.shape[0] - padding,
